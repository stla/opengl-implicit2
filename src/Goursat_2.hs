...
trianglesGoursat :: Voxel -> Double -> [NTriangle]
trianglesGoursat vxl l =
  map fromTriangle (computeContour3d' vxl Nothing l)
...
keyboard rot1 rot2 rot3 a b l voxelRef trianglesRef zoom c _ = do
  case c of
    ...
    'f' -> do
             ...
             l' <- get l
             let triangles = trianglesGoursat vxl l'
...
main = do
  ...
  let triangles = trianglesGoursat vxl 2.0
